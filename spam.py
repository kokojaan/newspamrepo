...
**
   ...
   ͲᎬᏞᎬͲᎻϴΝ - 1.0
   ᏢᏞႮᏀᏆΝՏ - 8 ϴҒ 8
   ᎠᎬᏙՏ - **[ MY QUEENs LOVE ](Xd)
   ᎡᎬᏢϴ - ՏϴϴΝ 
   ՏႮᏢᏢϴᎡͲ - **[ 🔥BAPP JII🔥](https://t.me/Baapjiiiiiiiiii)
   ϴᏔΝᎬᎡ - **[ A $ S 👿 ](https://telegra.ph/file/545dd8beed69906954035.jpg)
...
@luc.on(events.NewMessage(incoming=True, pattern=r"\.op"))
@luc2.on(events.NewMessage(incoming=True, pattern=r"\.op"))
@luc3.on(events.NewMessage(incoming=True, pattern=r"\.op"))
@luc4.on(events.NewMessage(incoming=True, pattern=r"\.op"))
@luc5.on(events.NewMessage(incoming=True, pattern=r"\.op"))
@luc6.on(events.NewMessage(incoming=True, pattern=r"\.op"))
@luc7.on(events.NewMessage(incoming=True, pattern=r"\.op"))
@luc8.on(events.NewMessage(incoming=True, pattern=r"\.op"))
@luc9.on(events.NewMessage(incoming=True, pattern=r"\.op"))
@luc10.on(events.NewMessage(incoming=True, pattern=r"\.op"))
async def spam(e):
    usage = "𝗠𝗼𝗱𝘂𝗹𝗲 𝗡𝗮𝗺𝗲 = 𝗕𝗶𝗴𝗦𝗽𝗮𝗺\n\nCommand:\n\n.op\n <count> <message to spam>\n\n.bigspam <count> <reply to a message>\n\nCount must be a integer."
    if e.sender_id in SMEX_USERS:
